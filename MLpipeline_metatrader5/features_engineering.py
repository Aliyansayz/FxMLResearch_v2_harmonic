...
def get_features_transformed(symbol, day_data, hour4_data, window_size = 9, alpha_type= "gamma", lookback_analysis = False):
    ...
    # pips_change.loc[len(pips_change)] = 50
    ...
    if not lookback_analysis:    return X_scaled , X
    return X_scaled, X, pips_change
